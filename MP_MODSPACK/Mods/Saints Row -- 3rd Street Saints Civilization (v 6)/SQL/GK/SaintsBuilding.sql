...
INSERT INTO Buildings
			(Type, Description, Civilopedia, Strategy, Help, Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River, 
			...
			MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, Cost, FaithCost, 
			UnlockedByBelief, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq, 
			...
			CapturePlunderModifier, PolicyCostModifier, PlotCultureCostModifier, GlobalPlotCultureCostModifier, PlotBuyCostModifier,
			...
			Espionage, Defense, ExtraCityHitPoints, GlobalDefenseMod, MinorFriendshipChange, VictoryPoints,
			...
			BuildingClass, ArtDefineTag, NearbyTerrainRequired, ProhibitedCityTerrain, VictoryPrereq,
			FreeStartEra, MaxStartEra, ObsoleteTech, EnhancedYieldTech, FreeBuilding, FreeBuildingThisCity, FreePromotion, TrainedFreePromotion,
			FreePromotionRemoved, ReplacementBuildingClass, PrereqTech, SpecialistType, SpecialistCount,
			SpecialistExtraCulture, GreatPeopleRateChange, CityWall, DisplayPosition, PortraitIndex, WonderSplashImage, WonderSplashAnchor,
...
SELECT		('BUILDING_SRTT_RIM_JOBS'), ('TXT_KEY_BUILDING_SRTT_RIM_JOBS'), ('TXT_KEY_BUILDING_SRTT_RIM_JOBS_TEXT'), ('TXT_KEY_BUILDING_SRTT_RIM_JOBS_STRATEGY'),
			('TXT_KEY_BUILDING_SRTT_RIM_JOBS_HELP'), Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River, 
			FreshWater, Mountain, NearbyMountainRequired, Hill, Flat, FoundsReligion, IsReligious, BorderObstacle, PlayerBorderObstacle, Capital, GoldenAge, 
			MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, Cost, FaithCost, 
			UnlockedByBelief, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq, 
			CultureRateModifier, GlobalCultureRateModifier, GreatPeopleRateModifier, GlobalGreatPeopleRateModifier, GreatGeneralRateModifier, GreatPersonExpendGold,
			...
			FreeStartEra, MaxStartEra, ObsoleteTech, EnhancedYieldTech, FreeBuilding, FreeBuildingThisCity, FreePromotion, TrainedFreePromotion,
			FreePromotionRemoved, ReplacementBuildingClass, PrereqTech, SpecialistType, SpecialistCount,
			SpecialistExtraCulture, GreatPeopleRateChange, CityWall, DisplayPosition, 3, WonderSplashImage, WonderSplashAnchor,
...
INSERT INTO Buildings
			(Type,							BuildingClass,	
			Cost,	FaithCost,	PrereqTech, NeverCapture,	NukeImmune,
			Description, Civilopedia, Strategy, Help)
VALUES		('BUILDING_SRTT_DUMMY_RESPECT',	'BUILDINGCLASS_SRTT_DUMMY_RESPECT',
			-1,		-1,			'NULL',		1,				1,
			'TXT_KEY_BUILDING_SRTT_DUMMY_RESPECT', 'TXT_KEY_BUILDING_SRTT_DUMMY_RESPECT_TEXT', 'TXT_KEY_BUILDING_SRTT_DUMMY_RESPECT_STRATEGY', 'TXT_KEY_BUILDING_SRTT_DUMMY_RESPECT_HELP');
