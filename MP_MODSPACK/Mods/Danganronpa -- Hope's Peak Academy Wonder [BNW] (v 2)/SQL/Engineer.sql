...
VALUES		('UNITCLASS_VV_SHSL_ENGINEER',	'TXT_KEY_UNIT_VV_SHSL_ENGINEER',	'UNIT_VV_SHSL_ENGINEER');
...
SELECT		('UNIT_VV_SHSL_ENGINEER'),	('TXT_KEY_UNIT_VV_SHSL_ENGINEER'),	Civilopedia,	Strategy,	('TXT_KEY_UNIT_VV_SHSL_ENGINEER_HELP'),
			Requirements, Combat, RangedCombat, Cost, FaithCost, RequiresFaithPurchaseEnabled, PurchaseOnly, MoveAfterPurchase, Moves, Immobile, Range, BaseSightRange, ('UNITCLASS_VV_SHSL_ENGINEER'), Special, Capture, CombatClass, Domain,
			CivilianAttackPriority, DefaultUnitAI, Food, NoBadGoodies, RivalTerritory, MilitarySupport, MilitaryProduction, Pillage, PillagePrereqTech, Found, FoundAbroad, CultureBombRadius, GoldenAgeTurns, FreePolicies,
			OneShotTourism, OneShotTourismPercentOthers, IgnoreBuildingDefense, PrereqResources, Mechanized, Suicide, CaptureWhileEmbarked, PrereqTech, ObsoleteTech, GoodyHutUpgradeUnitClass, HurryCostModifier, AdvancedStartCost,
			MinAreaSize, AirInterceptRange, AirUnitCap, NukeDamageLevel, WorkRate, NumFreeTechs, BaseBeakersTurnsToCount, BaseCultureTurnsToCount, RushBuilding, BaseHurry, HurryMultiplier, BaseGold, NumGoldPerEra,
			SpreadReligion, RemoveHeresy,ReligionSpreads,ReligiousStrength,FoundReligion,RequiresEnhancedReligion,ProhibitsSpread,CanBuyCityState,CombatLimit,RangeAttackOnlyInDomain,RangeAttackIgnoreLOS,Trade,NumExoticGoods,
...
UPDATE Units
SET BaseHurry	= CAST((BaseHurry*0.5) AS INT), HurryMultiplier	= CAST((HurryMultiplier*0.5) AS INT)
WHERE Type = 'UNIT_VV_SHSL_ENGINEER';
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	SelectionSound, FirstSelectionSound
...
INSERT INTO Unit_AITypes 	
			(UnitType, 				UnitAIType)
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	UnitAIType
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	FlavorType, Flavor * 20
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	PromotionType
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	BuildingType
...
VALUES		('UNIT_VV_SHSL_ENGINEER','BUILDINGCLASS_VV_KIBOUGAMINE');
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	BuildingType,	ProductionModifier
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	UnitClassType
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	GreatPersonType
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	ResourceType,	Cost
...
SELECT		('UNIT_VV_SHSL_ENGINEER'), 	YieldType,	Yield
...
INSERT INTO Unit_UniqueNames
			(UnitType,					UniqueName)
SELECT		('UNIT_VV_SHSL_ENGINEER'),	Tag
