...
--
-- See TechButtonInclude.lua for full details
--
...
--	for row in GameInfo.Technologies() do
	for row in ShowInTechTreeIterator("Technologies") do
		techPipes[row.Type] = 
		{
...
--		local prereq = GameInfo.Technologies[row.PrereqTech];
		local prereq = ShowInTechTreeLookup("Technologies", row.PrereqTech);
--		local tech = GameInfo.Technologies[row.TechType];
		local tech = ShowInTechTreeLookup("Technologies", row.TechType);
...
--	for tech in GameInfo.Technologies() do
	for tech in ShowInTechTreeIterator("Technologies") do
		AddTechButton( tech );
	end
...
--		local eraID = GameInfo.Eras[tech.Era].ID;
		local era = ShowInTechTreeLookup("Eras", tech.Era);
		if (era) then
		local eraID = era.ID;
...
--	for era in GameInfo.Eras() do
	for era in ShowInTechTreeIterator("Eras") do
