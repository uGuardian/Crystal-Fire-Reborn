...
--------------------------------------------------------------
print("Loading TSL Serializer v2...")
--------------------------------------------------------------
-- IMPORTANT:
...
5. Delete any existing TSL hook-up code, EXCEPT for OnModLoaded()
...
tableRoot = FValentine
tableName = "FValentineMod"
...
print("Loading Core TSL Serializer Components...")
include("TSLSerializerCoreV2.lua")
...
local function TSLSaveTable()
	if TSLMaster.processTableID == iTSLIndex or TSLMaster.processTableID == "debug" then
...
-- Stock TableSaverLoader Hookups beyond this point
...
--------------------------------------------------------------
print("TSL Serializer v2 loaded successfully.")