...
SELECT		('BUILDING_PIONEER_DINER'), ('TXT_KEY_BUILDING_PIONEER_DINER'), ('TXT_KEY_BUILDING_PIONEER_DINER_TEXT'), ('TXT_KEY_BUILDING_PIONEER_DINER_STRATEGY'),
			('TXT_KEY_BUILDING_PIONEER_DINER_HELP'), ThemingBonusHelp, Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River, 
			FreshWater, Mountain, NearbyMountainRequired, Hill, Flat, FoundsReligion, IsReligious, BorderObstacle, PlayerBorderObstacle, Capital, GoldenAge, 
			MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, NullifyInfluenceModifier, Cost, FaithCost, 
			LeagueCost, UnlockedByBelief, UnlockedByLeague, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq, 
			CultureRateModifier, GlobalCultureRateModifier, GreatPeopleRateModifier, GlobalGreatPeopleRateModifier, GreatGeneralRateModifier, GreatPersonExpendGold,
			...
			WonderSplashAudio, ('CIV_COLOR_ATLAS_JJBA_AMERICA'), ArtInfoCulturalVariation, ArtInfoEraVariation, ArtInfoRandomVariation
...
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_AreaYieldModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), BuildingClassType, Happiness
FROM Building_BuildingClassHappiness WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), BuildingClassType, YieldType, YieldChange
FROM Building_BuildingClassYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), BuildingClassType
...
SELECT		('BUILDING_PIONEER_DINER'), UnitType, NumUnits
FROM Building_FreeUnits WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), DomainType, Experience
FROM Building_DomainFreeExperiences WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_DomainFreeExperiencePerGreatWork
			(BuildingType, DomainType, Experience)
SELECT		('BUILDING_PIONEER_DINER'), DomainType, Experience
FROM Building_DomainFreeExperiencePerGreatWork WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), DomainType, Modifier
FROM Building_DomainProductionModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), SpecialistType, Count
FROM Building_FreeSpecialistCounts WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), FlavorType, Flavor+5
FROM Building_Flavors WHERE (BuildingType = 'BUILDING_HOSPITAL');

INSERT INTO Building_Flavors
			(BuildingType,				FlavorType,			Flavor)
VALUES		('BUILDING_PIONEER_DINER', 'FLAVOR_CULTURE',	15);
...
INSERT INTO Building_GlobalYieldModifiers
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_GlobalYieldModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), HurryType, HurryCostModifier
FROM Building_HurryModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), ResourceType
FROM Building_LocalResourceAnds WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_LocalResourceOrs
			(BuildingType, ResourceType)
SELECT		('BUILDING_PIONEER_DINER'), ResourceType
FROM Building_LocalResourceOrs WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_LockedBuildingClasses
			(BuildingType, BuildingClassType)
SELECT		('BUILDING_PIONEER_DINER'), BuildingClassType
FROM Building_LockedBuildingClasses WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), BuildingClassType, NumBuildingNeeded
FROM Building_PrereqBuildingClasses WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), ResourceType, Quantity
FROM Building_ResourceQuantity WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), ResourceType, Cost
FROM Building_ResourceQuantityRequirements WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), ResourceType, YieldType, Yield
FROM Building_ResourceYieldModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), ResourceType, CultureChange
FROM Building_ResourceCultureChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), ResourceType, FaithChange
FROM Building_ResourceFaithChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_RiverPlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_RiverPlotYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_SeaPlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_SeaPlotYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_LakePlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_LakePlotYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_SeaResourceYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_SeaResourceYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_ResourceYieldChanges
			(BuildingType, ResourceType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), ResourceType, YieldType, Yield
FROM Building_ResourceYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), FeatureType, YieldType, Yield
FROM Building_FeatureYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), TerrainType, YieldType, Yield
FROM Building_TerrainYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), SpecialistType, YieldType, Yield
FROM Building_SpecialistYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), UnitCombatType, Experience
FROM Building_UnitCombatFreeExperiences WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
SELECT		('BUILDING_PIONEER_DINER'), UnitCombatType, Modifier
FROM Building_UnitCombatProductionModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');

--Rim Jobs improves Armor production slightly
INSERT INTO Building_UnitCombatProductionModifiers
			(BuildingType,				UnitCombatType,		Modifier)
VALUES		('BUILDING_PIONEER_DINER',	'UNITCOMBAT_ARMOR',	10);
...
SELECT		('BUILDING_PIONEER_DINER'), TechType
FROM Building_TechAndPrereqs WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_YieldChanges
			(BuildingType,				YieldType,			Yield)
VALUES		('BUILDING_PIONEER_DINER',	'YIELD_CULTURE',	2);
...
INSERT INTO Building_YieldChangesPerPop
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_YieldChangesPerPop WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_YieldChangesPerReligion
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_YieldChangesPerReligion WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_TechEnhancedYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_TechEnhancedYieldChanges WHERE (BuildingType = 'BUILDING_HOSPITAL');
...
INSERT INTO Building_YieldModifiers
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PIONEER_DINER'), YieldType, Yield
FROM Building_YieldModifiers WHERE (BuildingType = 'BUILDING_HOSPITAL');

INSERT INTO Building_YieldModifiers
			(BuildingType,				YieldType,	Yield)
VALUES		('BUILDING_PIONEER_DINER', 'YIELD_FOOD',10);
...
SELECT		('BUILDING_PIONEER_DINER'), Description, Bonus, SameEra, UniqueEras, MustBeArt, MustBeArtifact, MustBeEqualArtArtifact, RequiresOwner, RequiresAnyButOwner, RequiresSamePlayer, RequiresUniquePlayers, AIPriority
FROM Building_ThemingBonuses WHERE (BuildingType = 'BUILDING_HOSPITAL');
