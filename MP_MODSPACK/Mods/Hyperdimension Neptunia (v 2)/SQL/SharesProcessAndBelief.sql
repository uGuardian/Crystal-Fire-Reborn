INSERT INTO Processes
			(Type,						IconAtlas,				PortraitIndex,	TechPrereq)
VALUES		('PROCESS_VV_HDN_SHARES',	'VV_HDN_SHARED_ATLAS',	0,				'TECH_PHILOSOPHY');


UPDATE Processes
SET Description = 'TXT_KEY_'||Type, Help = 'TXT_KEY_'||Type||'_HELP'
WHERE Type = 'PROCESS_VV_HDN_SHARES';


INSERT INTO Process_Flavors
			(ProcessType,				FlavorType,			Flavor)
VALUES		('PROCESS_VV_HDN_SHARES',	'FLAVOR_RELIGION',	10),
			('PROCESS_VV_HDN_SHARES',	'FLAVOR_CULTURE',	5),
			('PROCESS_VV_HDN_SHARES',	'FLAVOR_SCIENCE',	5),
			('PROCESS_VV_HDN_SHARES',	'FLAVOR_GOLD',		5);


INSERT INTO BuildingClasses
			(Type,								DefaultBuilding)
VALUES		('BUILDINGCLASS_VV_BASILICOM',		'BUILDING_VV_BASILICOM');
...
SELECT        ('BUILDING_VV_BASILICOM'), ('TXT_KEY_BUILDING_VV_BASILICOM'), ('TXT_KEY_BUILDING_VV_BASILICOM_TEXT'), ('TXT_KEY_BUILDING_VV_BASILICOM_STRATEGY'),
            ('TXT_KEY_BUILDING_VV_BASILICOM_HELP'), ThemingBonusHelp, Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River,  
            FreshWater, Mountain, NearbyMountainRequired, Hill, Flat, FoundsReligion, IsReligious, BorderObstacle, PlayerBorderObstacle, Capital, GoldenAge,  
            MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, NullifyInfluenceModifier, Cost, FaithCost,  
            LeagueCost, UnlockedByBelief, UnlockedByLeague, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq,  
            CultureRateModifier, GlobalCultureRateModifier, GreatPeopleRateModifier, GlobalGreatPeopleRateModifier, GreatGeneralRateModifier, GreatPersonExpendGold,
            ...
            TradeRouteRecipientBonus, TradeRouteTargetBonus, NumTradeRouteBonus, LandmarksTourismPercent, InstantMilitaryIncrease, GreatWorksTourismModifier,
            XBuiltTriggersIdeologyChoice, TradeRouteSeaDistanceModifier, TradeRouteSeaGoldBonus, TradeRouteLandDistanceModifier, TradeRouteLandGoldBonus,
            CityStateTradeRouteProductionModifier, GreatScientistBeakerModifier, ('BUILDINGCLASS_VV_BASILICOM'), ArtDefineTag, NearbyTerrainRequired, ProhibitedCityTerrain, VictoryPrereq,
            FreeStartEra, MaxStartEra, ObsoleteTech, EnhancedYieldTech, TechEnhancedTourism, FreeBuilding, FreeBuildingThisCity, FreePromotion, TrainedFreePromotion,
            FreePromotionRemoved, ReplacementBuildingClass, PrereqTech, PolicyBranchType, SpecialistType, SpecialistCount, GreatWorkSlotType, FreeGreatWork, GreatWorkCount,
            ...
            WonderSplashAudio, ('VV_HDN_SHARED_ATLAS'), ArtInfoCulturalVariation, ArtInfoEraVariation, ArtInfoRandomVariation
FROM Buildings WHERE (Type = 'BUILDING_PAGODA');
 
 
UPDATE Buildings
SET Happiness = 0, VV_SharesChange = 4, VV_SharesChangeOthers = 2
WHERE Type = 'BUILDING_VV_BASILICOM';
...
SELECT        ('BUILDING_VV_BASILICOM'), YieldType, Yield
...
SELECT        ('BUILDING_VV_BASILICOM'), BuildingClassType, Happiness
...
SELECT        ('BUILDING_VV_BASILICOM'), BuildingClassType, YieldType, YieldChange
...
SELECT        ('BUILDING_VV_BASILICOM'), BuildingClassType
...
SELECT        ('BUILDING_VV_BASILICOM'), UnitType, NumUnits
...
SELECT        ('BUILDING_VV_BASILICOM'), DomainType, Experience
...
SELECT        ('BUILDING_VV_BASILICOM'), DomainType, Modifier
...
SELECT        ('BUILDING_VV_BASILICOM'), SpecialistType, Count
...
VALUES			('BUILDING_VV_BASILICOM',	'FLAVOR_RELIGION',	6),
				('BUILDING_VV_BASILICOM',	'FLAVOR_SCIENCE',	6);
...
SELECT        ('BUILDING_VV_BASILICOM'), HurryType, HurryCostModifier
...
SELECT        ('BUILDING_VV_BASILICOM'), ResourceType
...
SELECT        ('BUILDING_VV_BASILICOM'), BuildingClassType, NumBuildingNeeded
...
SELECT        ('BUILDING_VV_BASILICOM'), ResourceType, Quantity
...
SELECT        ('BUILDING_VV_BASILICOM'), ResourceType, Cost
...
SELECT        ('BUILDING_VV_BASILICOM'), ResourceType, YieldType, Yield
...
SELECT        ('BUILDING_VV_BASILICOM'), ResourceType, CultureChange
...
SELECT        ('BUILDING_VV_BASILICOM'), ResourceType, FaithChange
...
SELECT        ('BUILDING_VV_BASILICOM'), FeatureType, YieldType, Yield
...
SELECT        ('BUILDING_VV_BASILICOM'), TerrainType, YieldType, Yield
...
SELECT        ('BUILDING_VV_BASILICOM'), SpecialistType, YieldType, Yield
...
SELECT        ('BUILDING_VV_BASILICOM'), UnitCombatType, Experience
...
SELECT        ('BUILDING_VV_BASILICOM'), UnitCombatType, Modifier
...
SELECT        ('BUILDING_VV_BASILICOM'), TechType
...
INSERT INTO Building_YieldChanges
            (BuildingType,				YieldType,		Yield)
VALUES      ('BUILDING_VV_BASILICOM',	'YIELD_FAITH',	2),
			('BUILDING_VV_BASILICOM',	'YIELD_SCIENCE',2);
...
SELECT        ('BUILDING_VV_BASILICOM'), Description, Bonus, SameEra, UniqueEras, MustBeArt, MustBeArtifact, MustBeEqualArtArtifact, RequiresOwner, RequiresAnyButOwner, RequiresSamePlayer, RequiresUniquePlayers, AIPriority
...
VALUES		('BELIEF_VV_BASILICOM',    'TXT_KEY_BELIEF_VV_BASILICOM',    'TXT_KEY_BELIEF_VV_BASILICOM_SHORT',   1);

 
INSERT INTO Belief_BuildingClassFaithPurchase
            (BeliefType,				BuildingClassType)
VALUES		('BELIEF_VV_BASILICOM',    'BUILDINGCLASS_VV_BASILICOM');