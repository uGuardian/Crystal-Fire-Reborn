...
SELECT     	('LEADER_VV_NEPGEAR'),			('POLICY_INDUSTRIOUS_X'),	('POLICY_CHARISMATIC_X')
WHERE EXISTS (SELECT * FROM Policies WHERE Type = 'POLICY_CHARISMATIC_X');

INSERT OR REPLACE INTO Leader_SharedTraits
            (LeaderType,					TraitOne,					TraitTwo)
SELECT     	('LEADER_VV_PURPLE_SISTER'),		('POLICY_INDUSTRIOUS_X'),	('POLICY_CHARISMATIC_X')
WHERE EXISTS (SELECT * FROM Policies WHERE Type = 'POLICY_CHARISMATIC_X');
------------------------------	
-- Leaders
------------------------------	
...
SET Text = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_CHARISMATIC_X' )
	THEN 'Nepgear [ICON_PRODUCTION][ICON_HAPPINESS_1]'
	ELSE 'Nepgear' END) 
WHERE Tag = 'TXT_KEY_LEADER_VV_NEPGEAR';

UPDATE Language_en_US 
SET Text = (CASE WHEN EXISTS(SELECT Type FROM Policies WHERE Type = 'POLICY_CHARISMATIC_X' )
	THEN 'Purple Sister [ICON_PRODUCTION][ICON_HAPPINESS_1]'
	ELSE 'Purple Sister' END) 
WHERE Tag = 'TXT_KEY_LEADER_VV_PURPLE_SISTER';
...
SET ArtStyleSuffix = (CASE WHEN EXISTS(SELECT ArtStyleSuffix FROM Civilizations WHERE ArtStyleSuffix = '_JAPAN' )
	THEN '_JAPAN'
	ELSE '_EURO' END) 
WHERE Type LIKE ('CIVILIZATION_VV_PLANEPTUNE_%');
...
INSERT OR IGNORE INTO Civilizations_YagemStartPosition
			(Type,							X,	Y)
SELECT		(SELECT Type FROM Civilizations WHERE Type LIKE 'CIVILIZATION_VV_PLANEPTUNE'),	X,	Y
...
SELECT		(SELECT Type FROM Civilizations WHERE Type LIKE 'CIVILIZATION_VV_PLANEPTUNE'),	Req1, Yield1, Req2, Yield2, Req3, Yield3, Req4, Yield4
...
SELECT		(SELECT Type FROM Civilizations WHERE Type LIKE 'CIVILIZATION_VV_PLANEPTUNE'),CultureType,		CultureEra
...
VALUES		('CIVILIZATION_VV_PLANEPTUNE_NG',	'JFD_Gamindustri'),
			('CIVILIZATION_VV_PLANEPTUNE_PS',	'JFD_Gamindustri');
...
SELECT		(SELECT Type FROM Civilizations WHERE Type LIKE 'CIVILIZATION_VV_PLANEPTUNE'),ColonyName,	LinguisticType, CultureType
...
VALUES		('CIVILIZATION_JAPAN',					'CIVILIZATION_VV_PLANEPTUNE_NG'),
			('CIVILIZATION_VV_PLANEPTUNE_NG',		'CIVILIZATION_JAPAN');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,				RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_VV_PLANEPTUNE_NG'),	('CIVILIZATION_PLANEPTUNE')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_PLANEPTUNE');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,					RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_PLANEPTUNE'),		('CIVILIZATION_VV_PLANEPTUNE_NG')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_PLANEPTUNE');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,				RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_LASTATION'),		('CIVILIZATION_VV_PLANEPTUNE_NG')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_LASTATION');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,					RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_VV_PLANEPTUNE_NG'),		('CIVILIZATION_LASTATION')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_LASTATION');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,				RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_VV_LEANBOX'),	('CIVILIZATION_VV_PLANEPTUNE_NG')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_VV_LEANBOX');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,					RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_VV_PLANEPTUNE_NG'),		('CIVILIZATION_VV_LEANBOX')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_VV_LEANBOX');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,				RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_VV_LOWEE'),	('CIVILIZATION_VV_PLANEPTUNE_NG')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_VV_LOWEE');

INSERT INTO Civilization_JFD_RevolutionaryCivilizationsToSpawn
			(CivilizationType,					RevolutionaryCivilizationType)
SELECT		('CIVILIZATION_VV_PLANEPTUNE_NG'),		('CIVILIZATION_VV_LOWEE')
WHERE EXISTS (SELECT Type FROM Civilizations WHERE Type = 'CIVILIZATION_VV_LOWEE'); */
...
VALUES		('LEADER_VV_NEPGEAR',		'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	9),
			('LEADER_VV_PURPLE_SISTER',	'FLAVOR_JFD_RELIGIOUS_INTOLERANCE',	9);
...
INSERT INTO Leader_Flavors
		(LeaderType,				FlavorType,				Flavor)
VALUES	('LEADER_VV_NEPGEAR',		'FLAVOR_JFD_MERCENARY',	0),
		('LEADER_VV_PURPLE_SISTER',	'FLAVOR_JFD_MERCENARY',	0);