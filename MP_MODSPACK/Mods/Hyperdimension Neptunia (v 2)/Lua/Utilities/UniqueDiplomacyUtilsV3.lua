...
-- Passing nil as the targetResponse will mean that this replaces all entries
-- that have the targetResponse.
...
function ChangeDiplomacyResponse(leaderType, targetResponseType, newResponse, targetResponse, bias)
	if (leaderType and (targetResponseType or targetResponse) and newResponse) then
		...
		if text then
			...
			elseif (targetResponse == nil) then
				--print("DB.Query will be UPDATE Diplomacy_Responses SET Response = '" .. newResponse .. "'" .. sBiasSection .." WHERE LeaderType = '" ..leaderType.. "' AND ResponseType = '" ..targetResponseType .. "'");
				for _ in DB.Query("UPDATE Diplomacy_Responses SET Response = '" .. newResponse .. "'" .. sBiasSection .." WHERE LeaderType = '" ..leaderType.. "' AND ResponseType = '" ..targetResponseType .. "'") do end
				--print(leaderType .. "'s " .. targetResponseType .. " changed to use " .. newResponse .. "!");
			else
