...
--Vicevirtuoso: Allow other scripts to refresh the data of this screen with a LuaEvent
function RepopulateGameMenuData()
	PopulateGameData();
	PopulateGameOptions();
	PopulateModData();
end

LuaEvents.RepopulateGameMenuData.Add(RepopulateGameMenuData)
