...
SELECT		('BUILDING_ARTHURIAN_COURT'), Description, Civilopedia, Strategy, Help,
			ThemingBonusHelp, Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River, 
			FreshWater, Mountain, NearbyMountainRequired, Hill, Flat, FoundsReligion, IsReligious, BorderObstacle, PlayerBorderObstacle, Capital, GoldenAge, 
			MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, NullifyInfluenceModifier, Cost, FaithCost, 
			LeagueCost, UnlockedByBelief, UnlockedByLeague, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq, 
...
UPDATE Buildings
SET PolicyCostModifier = -1
WHERE Type = 'BUILDING_ARTHURIAN_COURT';
...
UPDATE Buildings
SET IconAtlas = 'CIV_COLOR_ATLAS_SABER', PortraitIndex = 3
WHERE Type = 'BUILDING_ARTHURIAN_COURT';
...
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_AreaYieldModifiers WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), BuildingClassType, Happiness
FROM Building_BuildingClassHappiness WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), BuildingClassType, YieldType, YieldChange
FROM Building_BuildingClassYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), BuildingClassType
...
SELECT		('BUILDING_ARTHURIAN_COURT'), UnitType, NumUnits
FROM Building_FreeUnits WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), DomainType, Experience
FROM Building_DomainFreeExperiences WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_DomainFreeExperiencePerGreatWork
			(BuildingType, DomainType, Experience)
SELECT		('BUILDING_ARTHURIAN_COURT'), DomainType, Experience
FROM Building_DomainFreeExperiencePerGreatWork WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), DomainType, Modifier
FROM Building_DomainProductionModifiers WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), SpecialistType, Count
FROM Building_FreeSpecialistCounts WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), FlavorType, Flavor+5
FROM Building_Flavors WHERE (BuildingType = 'BUILDING_CASTLE');

INSERT INTO Building_Flavors
VALUES		('BUILDING_ARTHURIAN_COURT', 'FLAVOR_AIRLIFT', 10);
...
INSERT INTO Building_GlobalYieldModifiers
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_GlobalYieldModifiers WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), HurryType, HurryCostModifier
FROM Building_HurryModifiers WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType
FROM Building_LocalResourceAnds WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_LocalResourceOrs
			(BuildingType, ResourceType)
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType
FROM Building_LocalResourceOrs WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_LockedBuildingClasses
			(BuildingType, BuildingClassType)
SELECT		('BUILDING_ARTHURIAN_COURT'), BuildingClassType
FROM Building_LockedBuildingClasses WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), BuildingClassType, NumBuildingNeeded
FROM Building_PrereqBuildingClasses WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType, Quantity
FROM Building_ResourceQuantity WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType, Cost
...
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType, YieldType, Yield
FROM Building_ResourceYieldModifiers WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType, CultureChange
FROM Building_ResourceCultureChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType, FaithChange
FROM Building_ResourceFaithChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_RiverPlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_RiverPlotYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_SeaPlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_SeaPlotYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_LakePlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_LakePlotYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_SeaResourceYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_SeaResourceYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_ResourceYieldChanges
			(BuildingType, ResourceType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), ResourceType, YieldType, Yield
FROM Building_ResourceYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), FeatureType, YieldType, Yield
FROM Building_FeatureYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), TerrainType, YieldType, Yield
FROM Building_TerrainYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), SpecialistType, YieldType, Yield
FROM Building_SpecialistYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), UnitCombatType, Experience
FROM Building_UnitCombatFreeExperiences WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), UnitCombatType, Modifier
FROM Building_UnitCombatProductionModifiers WHERE (BuildingType = 'BUILDING_CASTLE');
...
SELECT		('BUILDING_ARTHURIAN_COURT'), TechType
FROM Building_TechAndPrereqs WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_YieldChangesPerPop
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_YieldChangesPerPop WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_YieldChangesPerReligion
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_YieldChangesPerReligion WHERE (BuildingType = 'BUILDING_CASTLE');
...
INSERT INTO Building_TechEnhancedYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_ARTHURIAN_COURT'), YieldType, Yield
FROM Building_TechEnhancedYieldChanges WHERE (BuildingType = 'BUILDING_CASTLE');
