...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ('TXT_KEY_BUILDING_PMMM_LUMINOUS_GARDEN'), ('TXT_KEY_BUILDING_PMMM_LUMINOUS_GARDEN_TEXT'), ('TXT_KEY_BUILDING_PMMM_LUMINOUS_GARDEN_STRATEGY'),
			('TXT_KEY_BUILDING_PMMM_LUMINOUS_GARDEN_HELP'), ThemingBonusHelp, Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River, 
			FreshWater, Mountain, NearbyMountainRequired, Hill, Flat, FoundsReligion, IsReligious, BorderObstacle, PlayerBorderObstacle, Capital, GoldenAge, 
			MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, NullifyInfluenceModifier, Cost, FaithCost, 
			LeagueCost, UnlockedByBelief, UnlockedByLeague, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq, 
			CultureRateModifier, GlobalCultureRateModifier, GreatPeopleRateModifier, GlobalGreatPeopleRateModifier, GreatGeneralRateModifier, GreatPersonExpendGold,
			...
			WonderSplashAudio, ('CIV_COLOR_ATLAS_MADOKA_TEMP'), ArtInfoCulturalVariation, ArtInfoEraVariation, ArtInfoRandomVariation
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_AreaYieldModifiers WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), BuildingClassType, Happiness
FROM Building_BuildingClassHappiness WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), BuildingClassType, YieldType, YieldChange
FROM Building_BuildingClassYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), BuildingClassType
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), UnitType, NumUnits
FROM Building_FreeUnits WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), DomainType, Experience
FROM Building_DomainFreeExperiences WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_DomainFreeExperiencePerGreatWork
			(BuildingType, DomainType, Experience)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), DomainType, Experience
FROM Building_DomainFreeExperiencePerGreatWork WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), DomainType, Modifier
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), SpecialistType, Count
FROM Building_FreeSpecialistCounts WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), FlavorType, Flavor+5
...
INSERT INTO Building_GlobalYieldModifiers
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_GlobalYieldModifiers WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), HurryType, HurryCostModifier
FROM Building_HurryModifiers WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType
FROM Building_LocalResourceAnds WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_LocalResourceOrs
			(BuildingType, ResourceType)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType
FROM Building_LocalResourceOrs WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_LockedBuildingClasses
			(BuildingType, BuildingClassType)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), BuildingClassType
FROM Building_LockedBuildingClasses WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), BuildingClassType, NumBuildingNeeded
FROM Building_PrereqBuildingClasses WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType, Quantity
FROM Building_ResourceQuantity WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType, Cost
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType, YieldType, Yield
FROM Building_ResourceYieldModifiers WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType, CultureChange
FROM Building_ResourceCultureChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), ResourceType, FaithChange
FROM Building_ResourceFaithChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_RiverPlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_RiverPlotYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_SeaPlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_SeaPlotYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_LakePlotYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_LakePlotYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_SeaResourceYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_SeaResourceYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), FeatureType, YieldType, Yield
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), TerrainType, YieldType, Yield
FROM Building_TerrainYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), SpecialistType, YieldType, Yield
FROM Building_SpecialistYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), UnitCombatType, Experience
FROM Building_UnitCombatFreeExperiences WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), UnitCombatType, Modifier
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), TechType
FROM Building_TechAndPrereqs WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_YieldChangesPerPop
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_YieldChangesPerPop WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_YieldChangesPerReligion
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_YieldChangesPerReligion WHERE (BuildingType = 'BUILDING_GARDEN');
...
INSERT INTO Building_TechEnhancedYieldChanges
			(BuildingType, YieldType, Yield)
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), YieldType, Yield
FROM Building_TechEnhancedYieldChanges WHERE (BuildingType = 'BUILDING_GARDEN');
...
SELECT		('BUILDING_PMMM_LUMINOUS_GARDEN'), Description, Bonus, SameEra, UniqueEras, MustBeArt, MustBeArtifact, MustBeEqualArtArtifact, RequiresOwner, RequiresAnyButOwner, RequiresSamePlayer, RequiresUniquePlayers, AIPriority
FROM Building_ThemingBonuses WHERE (BuildingType = 'BUILDING_GARDEN');
