...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'),	('TXT_KEY_UNIT_PMMM_HERALD_OF_MADOKA'),	('TXT_KEY_UNIT_PMMM_HERALD_OF_MADOKA_TEXT'),	('TXT_KEY_UNIT_PMMM_HERALD_OF_MADOKA_STRATEGY'),	('TXT_KEY_UNIT_PMMM_HERALD_OF_MADOKA_HELP'),
			Requirements, Combat, RangedCombat, Cost, FaithCost, RequiresFaithPurchaseEnabled, PurchaseOnly, MoveAfterPurchase, Moves, Immobile, Range, BaseSightRange, Class, Special, Capture, CombatClass, Domain,
			CivilianAttackPriority, DefaultUnitAI, Food, NoBadGoodies, RivalTerritory, MilitarySupport, MilitaryProduction, Pillage, PillagePrereqTech, Found, FoundAbroad, CultureBombRadius, GoldenAgeTurns, FreePolicies,
			OneShotTourism, OneShotTourismPercentOthers, IgnoreBuildingDefense, PrereqResources, Mechanized, Suicide, CaptureWhileEmbarked, PrereqTech, ObsoleteTech, GoodyHutUpgradeUnitClass, HurryCostModifier, AdvancedStartCost,
			MinAreaSize, AirInterceptRange, AirUnitCap, NukeDamageLevel, WorkRate, NumFreeTechs, BaseBeakersTurnsToCount, BaseCultureTurnsToCount, RushBuilding, BaseHurry, HurryMultiplier, BaseGold, NumGoldPerEra,
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	SelectionSound, FirstSelectionSound
...
INSERT INTO Unit_AITypes 	
			(UnitType, 				UnitAIType)
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	UnitAIType
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	FlavorType, Flavor
...
INSERT INTO Unit_Builds 	
			(UnitType, 				BuildType)
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), BuildType
FROM Unit_Builds WHERE (UnitType = 'UNIT_MISSIONARY');
--==========================================================================================================================
-- Unit_FreePromotions
--==========================================================================================================================
INSERT INTO Unit_FreePromotions 	
			(UnitType, 				PromotionType)
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	PromotionType
FROM Unit_FreePromotions WHERE (UnitType = 'UNIT_MISSIONARY');

INSERT INTO Unit_FreePromotions 	
			(UnitType, 							PromotionType)
VALUES		('UNIT_PMMM_HERALD_OF_MADOKA', 	'PROMOTION_PMMM_HERALD_OF_MADOKA');

DELETE FROM Unit_FreePromotions
WHERE UnitType = 'UNIT_PMMM_HERALD_OF_MADOKA' AND PromotionType = 'PROMOTION_SIGHT_PENALTY';
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	BuildingType
FROM Unit_Buildings WHERE (UnitType = 'UNIT_MISSIONARY');
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	BuildingClassType
FROM Unit_BuildingClassRequireds WHERE (UnitType = 'UNIT_MISSIONARY');
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	BuildingType,	ProductionModifier
FROM Unit_ProductionModifierBuildings WHERE (UnitType = 'UNIT_MISSIONARY');
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	UnitClassType
FROM Unit_ClassUpgrades WHERE (UnitType = 'UNIT_MISSIONARY');
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	GreatPersonType
FROM Unit_GreatPersons WHERE (UnitType = 'UNIT_MISSIONARY');
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	ResourceType,	Cost
FROM Unit_ResourceQuantityRequirements WHERE (UnitType = 'UNIT_MISSIONARY');
...
SELECT		('UNIT_PMMM_HERALD_OF_MADOKA'), 	YieldType,	Yield
FROM Unit_YieldFromKills WHERE (UnitType = 'UNIT_MISSIONARY');