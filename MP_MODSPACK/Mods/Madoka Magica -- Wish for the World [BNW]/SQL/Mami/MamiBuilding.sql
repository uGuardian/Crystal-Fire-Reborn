...
VALUES		('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_1','BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_1'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_2','BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_2'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_4','BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_4'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_8','BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_8'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_16','BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_16'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_32','BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_32'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_1','BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_1'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_2','BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_2'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_4','BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_4'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_8','BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_8'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_16','BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_16'),
			('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_32','BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_32');
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ('TXT_KEY_BUILDING_PMMM_TEAHOUSE'), ('TXT_KEY_BUILDING_PMMM_TEAHOUSE_TEXT'), ('TXT_KEY_BUILDING_PMMM_TEAHOUSE_STRATEGY'),
			('TXT_KEY_BUILDING_PMMM_TEAHOUSE_HELP'), ThemingBonusHelp, Quote, GoldMaintenance, MutuallyExclusiveGroup, TeamShare, Water, River, 
			FreshWater, Mountain, NearbyMountainRequired, Hill, Flat, FoundsReligion, IsReligious, BorderObstacle, PlayerBorderObstacle, Capital, GoldenAge, 
			MapCentering, NeverCapture, NukeImmune, AllowsWaterRoutes, ExtraLuxuries, DiplomaticVoting, AffectSpiesNow, NullifyInfluenceModifier, Cost, FaithCost, 
			LeagueCost, UnlockedByBelief, UnlockedByLeague, HolyCity, NumCityCostMod, HurryCostModifier, MinAreaSize, ConquestProb, CitiesPrereq, LevelPrereq, 
			CultureRateModifier, GlobalCultureRateModifier, GreatPeopleRateModifier, GlobalGreatPeopleRateModifier, GreatGeneralRateModifier, GreatPersonExpendGold,
			...
			WonderSplashAudio, ('CIV_COLOR_ATLAS_MAMI'), ArtInfoCulturalVariation, ArtInfoEraVariation, ArtInfoRandomVariation
...
SELECT		DefaultBuilding,							Type,
			-1,		-1,			-1,				null,		1,				1
FROM BuildingClasses WHERE Type LIKE ('BUILDINGCLASS_PMMM_TEAHOUSE_MAMI_DUMMY_%');
...
SELECT		DefaultBuilding,							Type,
			-1,		-1,			-1,				null,		1,				1
FROM BuildingClasses WHERE Type LIKE ('BUILDINGCLASS_PMMM_TEAHOUSE_FRIEND_DUMMY_%');


INSERT INTO Building_BuildingClassYieldChanges
			(BuildingType,		BuildingClassType,				YieldType,				YieldChange)
SELECT		Type,				('BUILDINGCLASS_CARAVANSARY'), ('YIELD_PRODUCTION'),	CAST(REPLACE(Type, 'BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_', '') AS INT)
FROM Buildings WHERE Type LIKE ('BUILDING_PMMM_TEAHOUSE_MAMI_DUMMY_%');

INSERT INTO Building_BuildingClassYieldChanges
			(BuildingType,		BuildingClassType,			YieldType,				YieldChange)
SELECT		Type,				('BUILDINGCLASS_PALACE'),	('YIELD_PRODUCTION'),	CAST(REPLACE(Type, 'BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_', '') AS INT)
FROM Buildings WHERE Type LIKE ('BUILDING_PMMM_TEAHOUSE_FRIEND_DUMMY_%');
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), YieldType, Yield
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), BuildingClassType, Happiness
...
INSERT INTO Building_BuildingClassYieldChanges
			(BuildingType, BuildingClassType, YieldType, YieldChange)
SELECT		('BUILDING_PMMM_TEAHOUSE'), BuildingClassType, YieldType, YieldChange
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), BuildingClassType
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), UnitType, NumUnits
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), DomainType, Experience
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), DomainType, Modifier
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), SpecialistType, Count
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), FlavorType, Flavor+5
FROM Building_Flavors WHERE (BuildingType = 'BUILDING_CARAVANSARY');

INSERT INTO Building_Flavors
VALUES		('BUILDING_PMMM_TEAHOUSE', 'FLAVOR_AIRLIFT', 10);
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), HurryType, HurryCostModifier
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ResourceType
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), BuildingClassType, NumBuildingNeeded
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ResourceType, Quantity
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ResourceType, Cost
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ResourceType, YieldType, Yield
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ResourceType, CultureChange
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), ResourceType, FaithChange
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), FeatureType, YieldType, Yield
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), TerrainType, YieldType, Yield
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), SpecialistType, YieldType, Yield
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), UnitCombatType, Experience
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), UnitCombatType, Modifier
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), TechType
...
SELECT		('BUILDING_PMMM_TEAHOUSE'), Description, Bonus, SameEra, UniqueEras, MustBeArt, MustBeArtifact, MustBeEqualArtArtifact, RequiresOwner, RequiresAnyButOwner, RequiresSamePlayer, RequiresUniquePlayers, AIPriority
